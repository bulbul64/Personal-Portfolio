...
export default function SkillsSection() {
  return (
    <div className="p-10 relative">
      ...
      {/* Dynamic Rotating Aura */}
      <div className="absolute inset-0 flex justify-center items-center pointer-events-none">
        <div className="w-[600px] h-[600px] rounded-full bg-gradient-to-r from-amber-400 via-pink-500 to-purple-500 opacity-10 blur-3xl animate-rotate-colors hover:opacity-30"></div>
      </div>

      {/* Skills Grid */}
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6 relative z-10 text-center">
        {skills.map((skill) => (
          <div
            key={skill.id}
