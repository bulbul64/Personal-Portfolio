...
export default function Hero() {
  return (
    ...
    >
      {/* Left Column */}
      <motion.div
        className="w-full md:w-1/2 flex flex-col gap-3 text-gray-800 dark:text-white transition-colors duration-500"
      ...
      >
        ...
        <div className="flex flex-wrap items-center gap-3 mt-3">
          <Button
            className="bg-amber-500 dark:bg-[#D3E97A] text-white dark:text-black 
                             px-5 py-2 rounded-lg shadow hover:scale-105 hover:brightness-110 
          ...
          <div className="flex items-center gap-3">
            ...
            >
              <FaLinkedin
                size={24}
                className="bg-amber-500 dark:bg-[#D3E97A] text-white dark:text-black 
                           rounded-lg p-1 shadow hover:scale-110 hover:brightness-110 
      ...
      >
        <img
          src="/img.jpg"
          alt="Hero"
          className="w-full max-w-[220px] sm:max-w-xs md:max-w-sm rounded-lg 
                     shadow-md hover:scale-105 transition-transform duration-500 ease-out
                     bg-gray-100 dark:bg-[#111] object-cover"
        />
      </motion.div>
    </motion.section>
  );
